...
<main>
    <div class="container">
        <h3 class="text-center">Liệt Kê Hotel</h3>
        <table class="table">
            <thead>
                <tr>
                    <th scope="col">ID</th>
                    <th scope="col">Tên hotel</th>
                    <th scope="col">Ảnh</th>
                    <th scope="col">Banner</th>
                    <th scope="col">Số sao</th>
                    <th scope="col">Địa chỉ</th>
                    <th scope="col">Giá hotel</th>
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            <th><?php echo $i; ?></th>
                            <td  class="hoverable-cell"><?php echo $value['namehotel']; ?></td>
                            <td><img src="../<?php echo $value['imghotel']; ?>" alt="" width="50px" height="50px"></td>
                            <td><?php echo $value['bannerhotel']; ?></td>
                            <td><?php echo $value['sosaohotel']; ?></td>
                            <td><?php echo $value['diachihotel']; ?></td>
                            <td><?php echo number_format($value['giahotel'],0,',','.').' đ'; ?></td>
                            <td><?php echo number_format($value['giahotelsale'],0,',','.').' đ'; ?></td>
                            <td>
                                <button type="button" class="btn btn-primary my-1">
                                    <a class="text-white text-decoration-none" href="<?php echo BASE_URL ?>hotel/edit_hotel/<?php echo $value['id_hotel'] ?>">Cập Nhật</a>
                                </button> 
                                <button type="button" class="btn btn-primary my-1 " name="delete-contact">
                                    <a class="text-white text-decoration-none" href="<?php echo BASE_URL ?>hotel/delete_hotel/<?php echo $value['id_hotel'] ?>">Xóa</a>
                                </button>
                            </td>
                        </tr>
                <?php
