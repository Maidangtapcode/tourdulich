        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th scope="col">Mô tả 1</th>
                    <th scope="col">Mô tả 2</th>
                    <th scope="col">Mô tả 3</th>
                    <th scope="col">Mô tả 4</th>
            ...
            <tbody>
                <?php
                $i = 0;
                if (is_array($tour) || is_object($tour)) {
                    foreach ($tour as $key => $value) {
                        $i++;
                ?>
                        <tr>
                            <th><?php echo $i; ?></th>
                            <td  class="hoverable-cell"><?php echo $value['nametour']; ?></td>
                            <td><img src="../<?php echo $value['imagetour']; ?>" alt="" width="50px" height="50px"></td>
                            <td><?php echo $value['bannertour']; ?></td>
                            <td><?php echo $value['labeltour1']; ?></td>
                            <td><?php echo $value['labeltour2']; ?></td>
                            <td><?php echo $value['labeltour3']; ?></td>
                            <td><?php echo $value['labeltour4']; ?></td>
                            <td><?php echo number_format($value['giatour'],0,',','.').' đ'; ?></td>
                            <td>
                                <button type="button" class="btn btn-primary my-1">
                                    <a class="text-white text-decoration-none" href="<?php echo BASE_URL ?>tour/edit_tour/<?php echo $value['id_tour'] ?>">Cập Nhật</a>
                                </button>
                                <button type="button" class="btn btn-primary my-1" name="delete-contact">
                                    <a class="text-white text-decoration-none" href="<?php echo BASE_URL ?>tour/delete_tour/<?php echo $value['id_tour'] ?>">Xóa</a>
                                </button>
                            </td>
                        </tr>
                <?php
